...
### Starting Economy
- **New Game**: Begin with 280 credits; every Spawner begins empty and needs a purchased scrap delivery
- **Minimum Factory**: 1 Spawner (50) + 5 Conveyors (50) + 1 Seller (50) = 150 credits
- **Mistake Buffer**: 130 credits remain before the first 40-credit Can Bale purchase, leaving 90 credits afterward
...
2. Place a Spawner and purchase a Can Bale, then sell it raw or process it for a larger return
